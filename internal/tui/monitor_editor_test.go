...
func TestMoveMonitor(t *testing.T) {
	testCases := []struct {
		...
		{
			name:         "Snap monitor center to other monitor center horizontally",
			setupFile:    "testdata/monitors_for_center_snapping.json",
			monitorID:    0,
			dx:           tui.DeltaMore,
			dy:           tui.DeltaNone,
			expectedX:    1730,
		...
		{
			name:         "Snap monitor center to other monitor center vertically",
			setupFile:    "testdata/monitors_for_center_snapping_vertical.json",
			monitorID:    0,
			dx:           tui.DeltaNone,
			dy:           tui.DeltaMore,
			expectedX:    0,
		...
		{
			name:         "Snap monitor left edge to other monitor center",
			setupFile:    "testdata/monitors_for_edge_to_center_snapping.json",
			monitorID:    0,
			dx:           tui.DeltaMore,
			dy:           tui.DeltaNone,
			expectedX:    2940,
		...
		{
			name:         "Snap monitor right edge to other monitor center",
			setupFile:    "testdata/monitors_for_edge_to_center_snapping_right.json",
			monitorID:    0,
			dx:           tui.DeltaMore,
			dy:           tui.DeltaNone,
			expectedX:    -430,
		...
		{
			name:         "Snap monitor top edge to other monitor center",
			setupFile:    "testdata/monitors_for_edge_to_center_snapping_top.json",
			monitorID:    0,
			dx:           tui.DeltaNone,
			dy:           tui.DeltaLess,
			expectedX:    0,
		...
		{
			name:         "Snap monitor bottom edge to other monitor center",
			setupFile:    "testdata/monitors_for_edge_to_center_snapping_bottom.json",
			monitorID:    0,
			dx:           tui.DeltaNone,
			dy:           tui.DeltaMore,
			expectedX:    0,
